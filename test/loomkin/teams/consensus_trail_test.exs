defmodule Loomkin.Teams.ConsensusTrailTest do
  ...
  describe "collaboration event emission" do
    test "emit_consensus_success broadcasts collab event", %{team_id: team_id} do
      ...
      assert_receive {:collab_event, payload}, 500
  ...
  describe "full debate integration" do
    test "consensus path produces graph trail + success event", %{team_id: team_id} do
      ...
      assert_receive {:debate_start, debate_id, "testing framework", _}, 1_000
      ...
      assert_receive {:debate_vote, ^debate_id, _}, 5_000
      ...
      assert_receive {:collab_event, %{type: :consensus_success}}, 1_000
    end
    ...
    test "deadlock path produces graph trail + deadlock event", %{team_id: team_id} do
      ...
      assert_receive {:debate_start, debate_id, "db choice", _}, 1_000
      assert_receive {:debate_propose, ^debate_id, 1, _}, 500
      ...
      assert_receive {:collab_event, %{type: :consensus_deadlock}}, 1_000

      # Verify escalation event was emitted (policy is escalate_to_user)
      assert_receive {:collab_event, %{type: :consensus_escalation}}, 1_000
    end
  end
